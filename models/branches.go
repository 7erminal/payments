...
type Branches struct {
	BranchId          int64  `orm:"auto" orm: "omitempty"`
	BranchName        string `orm:"size(255)"`
	BranchAddress     string `orm:"size(255)"orm: "omitempty" `
	BranchNumber      string `orm:"size(255)" orm: "omitempty"`
	BranchDescription string `orm:"size(255)" orm: "omitempty"`
	BranchLocation    string `orm:"size(255)" orm: "omitempty"`
	BranchPhoneNumber string `orm:"size(40)" orm: "omitempty"`
}
