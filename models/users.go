...
type Users struct {
	...
	LastName     string `orm:"size(255)" orm: "omitempty"`
	OtherNames   string `orm:"size(255)" orm: "omitempty"`
	...
	CreatedBy    int 	`orm: "omitempty" default: 1`
	ModifiedBy   int 	`orm: "omitempty" default: 1`
	Active       int 	`orm: "omitempty" default: 1`
